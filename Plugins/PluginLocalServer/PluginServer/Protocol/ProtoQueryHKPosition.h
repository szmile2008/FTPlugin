...
class CProtoQueryHKPosition : public CProtoParseBase
{
public:
	//tomodify 1
...
public:
	CProtoQueryHKPosition();
	virtual ~CProtoQueryHKPosition();
...
private:
	...
	void GetHKOrderArrField(VT_PROTO_FIELD &vtField, const QueryPositionAckItem &ackItem);
