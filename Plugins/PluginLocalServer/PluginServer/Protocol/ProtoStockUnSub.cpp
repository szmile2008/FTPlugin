...
CProtoStockUnSub::CProtoStockUnSub()
{
	m_pReqData = NULL;
	m_pAckData = NULL;
}
...
bool CProtoStockUnSub::ParseJson_Req(const Json::Value &jsnVal)
{
...
bool CProtoStockUnSub::ParseJson_Ack(const Json::Value &jsnVal)
{
...
bool CProtoStockUnSub::MakeJson_Req(Json::Value &jsnVal)
{
	CHECK_RET(m_pReqData != NULL, false);
...
bool CProtoStockUnSub::MakeJson_Ack(Json::Value &jsnVal)
{
	CHECK_RET(m_pAckData != NULL, false);
...
void CProtoStockUnSub::SetProtoData_Req(ProtoReqDataType *pData)
{
	m_pReqData = pData;
}

void CProtoStockUnSub::SetProtoData_Ack(ProtoAckDataType *pData)
{
	m_pAckData = pData;
}

//tomodify 3(数组等复杂结构或单层的结构体)
bool CProtoStockUnSub::ParseProtoBody_Req(const Json::Value &jsnVal, ProtoReqDataType &data)
{	
...
bool CProtoStockUnSub::ParseProtoBody_Ack(const Json::Value &jsnVal, ProtoAckDataType &data)
{
...
bool CProtoStockUnSub::MakeProtoBody_Req(Json::Value &jsnVal, const ProtoReqDataType &data)
{
...
bool CProtoStockUnSub::MakeProtoBody_Ack(Json::Value &jsnVal, const ProtoAckDataType &data)
{
...
//tomodify 7
void CProtoStockUnSub::GetProtoBodyField_Req(VT_PROTO_FIELD &vtField, const ProtoReqBodyType &reqData)
{
	...
	void *arPtr[] = {
		&body.nStockSubType, &body.nStockMarket, &body.strStockCode, 
	};
...
//tomodify 8
void CProtoStockUnSub::GetProtoBodyField_Ack(VT_PROTO_FIELD &vtField, const ProtoAckBodyType &ackData)
{
	static BOOL arOptional[] = {
		FALSE, FALSE, FALSE,
	};
