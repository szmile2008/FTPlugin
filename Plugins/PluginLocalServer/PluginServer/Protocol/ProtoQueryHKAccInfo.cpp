...
CProtoQueryHKAccInfo::CProtoQueryHKAccInfo()
{
	m_pReqData = NULL;
	m_pAckData = NULL;
}
...
bool CProtoQueryHKAccInfo::ParseJson_Req(const Json::Value &jsnVal)
{
...
bool CProtoQueryHKAccInfo::ParseJson_Ack(const Json::Value &jsnVal)
{
...
bool CProtoQueryHKAccInfo::MakeJson_Req(Json::Value &jsnVal)
{
	CHECK_RET(m_pReqData != NULL, false);
...
bool CProtoQueryHKAccInfo::MakeJson_Ack(Json::Value &jsnVal)
{
	CHECK_RET(m_pAckData != NULL, false);
...
void CProtoQueryHKAccInfo::SetProtoData_Req(ProtoReqDataType *pData)
{
	m_pReqData = pData;
}

void CProtoQueryHKAccInfo::SetProtoData_Ack(ProtoAckDataType *pData)
{
	m_pAckData = pData;
}

//tomodify 3(数组等复杂结构或单层的结构体)
bool CProtoQueryHKAccInfo::ParseProtoBody_Req(const Json::Value &jsnVal, ProtoReqDataType &data)
{	
...
bool CProtoQueryHKAccInfo::ParseProtoBody_Ack(const Json::Value &jsnVal, ProtoAckDataType &data)
{
...
bool CProtoQueryHKAccInfo::MakeProtoBody_Req(Json::Value &jsnVal, const ProtoReqDataType &data)
{
...
bool CProtoQueryHKAccInfo::MakeProtoBody_Ack(Json::Value &jsnVal, const ProtoAckDataType &data)
{
...
//tomodify 7
void CProtoQueryHKAccInfo::GetProtoBodyField_Req(VT_PROTO_FIELD &vtField, const ProtoReqBodyType &reqData)
{
...
//tomodify 8
void CProtoQueryHKAccInfo::GetProtoBodyField_Ack(VT_PROTO_FIELD &vtField, const ProtoAckBodyType &ackData)
{
	static BOOL arOptional[] = {
		FALSE, FALSE,
	...
	static EProtoFildType arFieldType[] = {
		ProtoFild_Int32, ProtoFild_Int32, 
		ProtoFild_Int64, ProtoFild_Int64, ProtoFild_Int64, ProtoFild_Int64,
		ProtoFild_Int64, ProtoFild_Int64, ProtoFild_Int64,
		ProtoFild_Int64, ProtoFild_Int64, ProtoFild_Int64,
	};
	static LPCSTR arFieldKey[] = {
		"EnvType",	"Cookie",
		"Power",	"ZCJZ",		"ZQSZ", "XJJY", 
		"KQXJ",		"DJZJ",		"ZSJE",
		"ZGJDE",	"YYJDE",	"GPBZJ"
	};
	...
	void *arPtr[] = {
		&body.nEnvType,		&body.nCookie,
		&body.nPower,		&body.nZcjz,	&body.nZqsz,	&body.nXjjy,
		&body.nKqxj,		&body.nDjzj,	&body.nZsje,
		&body.nZgjde,		&body.nYyjde,	&body.nGpbzj
	};
