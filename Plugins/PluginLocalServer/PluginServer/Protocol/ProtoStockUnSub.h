...
class CProtoStockUnSub : public CProtoParseBase
{
public:
	//tomodify 1
	typedef StockUnSub_Req		ProtoReqDataType;
	typedef StockUnSub_Ack		ProtoAckDataType;

	//tomodify 2
	typedef StockUnSubReqBody	   ProtoReqBodyType;
	typedef StockUnSubAckBody	   ProtoAckBodyType;


public:
	CProtoStockUnSub();
	virtual ~CProtoStockUnSub();
