...
class CProtoUnlockTrade : public CProtoParseBase
{
public:
	//tomodify 1
	typedef UnlockTrade_Req		ProtoReqDataType;
	typedef UnlockTrade_Ack		ProtoAckDataType;

	//tomodify 2
	typedef UnlockTradeReqBody	   ProtoReqBodyType;
	typedef UnlockTradeAckBody	   ProtoAckBodyType;


public:
	CProtoUnlockTrade();
	virtual ~CProtoUnlockTrade();
