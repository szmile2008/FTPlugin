...
class CProtoKLData : public CProtoParseBase
{
public:
	//tomodify 1
	typedef KLData_Req		ProtoReqDataType;
	typedef KLData_Ack		ProtoAckDataType;

	//tomodify 2
	typedef KLDataReqBody	ProtoReqBodyType;
	typedef KLDataAckBody	ProtoAckBodyType;


public:
	CProtoKLData();
	virtual ~CProtoKLData();
...
private:
	...
	void GetKLDataArrField(VT_PROTO_FIELD &vtField, const KLDataAckItem &ackItem);
