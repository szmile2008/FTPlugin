...
CProtoQueryAccInfo::CProtoQueryAccInfo()
{
	m_pReqData = NULL;
	m_pAckData = NULL;
}
...
bool CProtoQueryAccInfo::ParseJson_Req(const Json::Value &jsnVal)
{
...
bool CProtoQueryAccInfo::ParseJson_Ack(const Json::Value &jsnVal)
{
...
bool CProtoQueryAccInfo::MakeJson_Req(Json::Value &jsnVal)
{
	CHECK_RET(m_pReqData != NULL, false);
...
bool CProtoQueryAccInfo::MakeJson_Ack(Json::Value &jsnVal)
{
	CHECK_RET(m_pAckData != NULL, false);
...
void CProtoQueryAccInfo::SetProtoData_Req(ProtoReqDataType *pData)
{
	m_pReqData = pData;
}

void CProtoQueryAccInfo::SetProtoData_Ack(ProtoAckDataType *pData)
{
	m_pAckData = pData;
}

//tomodify 3(数组等复杂结构或单层的结构体)
bool CProtoQueryAccInfo::ParseProtoBody_Req(const Json::Value &jsnVal, ProtoReqDataType &data)
{	
...
bool CProtoQueryAccInfo::ParseProtoBody_Ack(const Json::Value &jsnVal, ProtoAckDataType &data)
{
...
bool CProtoQueryAccInfo::MakeProtoBody_Req(Json::Value &jsnVal, const ProtoReqDataType &data)
{
...
bool CProtoQueryAccInfo::MakeProtoBody_Ack(Json::Value &jsnVal, const ProtoAckDataType &data)
{
...
//tomodify 7
void CProtoQueryAccInfo::GetProtoBodyField_Req(VT_PROTO_FIELD &vtField, const ProtoReqBodyType &reqData)
{
...
//tomodify 8
void CProtoQueryAccInfo::GetProtoBodyField_Ack(VT_PROTO_FIELD &vtField, const ProtoAckBodyType &ackData)
{
	static BOOL arOptional[] = {
		FALSE, FALSE,
