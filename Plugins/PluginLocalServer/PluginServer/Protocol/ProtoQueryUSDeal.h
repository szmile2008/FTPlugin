...
class CProtoQueryUSDeal : public CProtoParseBase
{
public:
	//tomodify 1
	typedef QueryUSDeal_Req		ProtoReqDataType;
	typedef QueryUSDeal_Ack		ProtoAckDataType;

	//tomodify 2
	typedef QueryUSDealReqBody	ProtoReqBodyType;
	typedef QueryUSDealAckBody	ProtoAckBodyType;


public:
	CProtoQueryUSDeal();
	virtual ~CProtoQueryUSDeal();
...
private:
	...
	void GetUSDealArrField(VT_PROTO_FIELD &vtField, const QueryUSDealAckItem &ackItem);
