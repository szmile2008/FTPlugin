...
class CProtoBasicPrice : public CProtoParseBase
{
public:
	//tomodify 1
	typedef BasicPrice_Req		ProtoReqDataType;
	typedef BasicPrice_Ack		ProtoAckDataType;

	//tomodify 2
	typedef BasicPriceReqBody	   ProtoReqBodyType;
	typedef BasicPriceAckBody	   ProtoAckBodyType;


public:
	CProtoBasicPrice();
	virtual ~CProtoBasicPrice();
