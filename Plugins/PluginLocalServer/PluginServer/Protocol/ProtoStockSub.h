...
class CProtoStockSub : public CProtoParseBase
{
public:
	//tomodify 1
	typedef StockSub_Req		ProtoReqDataType;
	typedef StockSub_Ack		ProtoAckDataType;

	//tomodify 2
	typedef StockSubReqBody	   ProtoReqBodyType;
	typedef StockSubAckBody	   ProtoAckBodyType;


public:
	CProtoStockSub();
	virtual ~CProtoStockSub();
