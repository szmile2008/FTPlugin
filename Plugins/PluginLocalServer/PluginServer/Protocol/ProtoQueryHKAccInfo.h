...
class CProtoQueryHKAccInfo : public CProtoParseBase
{
public:
	//tomodify 1
	typedef QueryHKAccInfo_Req		ProtoReqDataType;
	typedef QueryHKAccInfo_Ack		ProtoAckDataType;

	//tomodify 2
	typedef QueryHKAccInfoReqBody	   ProtoReqBodyType;
	typedef QueryHKAccInfoAckBody	   ProtoAckBodyType;


public:
	CProtoQueryHKAccInfo();
	virtual ~CProtoQueryHKAccInfo();
