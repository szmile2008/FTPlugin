...
CProtoSetOrderStatus::CProtoSetOrderStatus()
{
	m_pReqData = NULL;
	m_pAckData = NULL;
}
...
bool CProtoSetOrderStatus::ParseJson_Req(const Json::Value &jsnVal)
{
...
bool CProtoSetOrderStatus::ParseJson_Ack(const Json::Value &jsnVal)
{
...
bool CProtoSetOrderStatus::MakeJson_Req(Json::Value &jsnVal)
{
	CHECK_RET(m_pReqData != NULL, false);
...
bool CProtoSetOrderStatus::MakeJson_Ack(Json::Value &jsnVal)
{
	CHECK_RET(m_pAckData != NULL, false);
...
void CProtoSetOrderStatus::SetProtoData_Req(ProtoReqDataType *pData)
{
	m_pReqData = pData;
}

void CProtoSetOrderStatus::SetProtoData_Ack(ProtoAckDataType *pData)
{
	m_pAckData = pData;
}

//tomodify 3(数组等复杂结构或单层的结构体)
bool CProtoSetOrderStatus::ParseProtoBody_Req(const Json::Value &jsnVal, ProtoReqDataType &data)
{	
...
bool CProtoSetOrderStatus::ParseProtoBody_Ack(const Json::Value &jsnVal, ProtoAckDataType &data)
{
...
bool CProtoSetOrderStatus::MakeProtoBody_Req(Json::Value &jsnVal, const ProtoReqDataType &data)
{
...
bool CProtoSetOrderStatus::MakeProtoBody_Ack(Json::Value &jsnVal, const ProtoAckDataType &data)
{
...
//tomodify 7
void CProtoSetOrderStatus::GetProtoBodyField_Req(VT_PROTO_FIELD &vtField, const ProtoReqBodyType &reqData)
{
	...
	static LPCSTR arFieldKey[] = {
		"EnvType",	"Cookie",	"OrderID", "LocalID", "SetOrderStatus",		
	};

	ProtoReqBodyType &body = const_cast<ProtoReqBodyType &>(reqData);	
	void *arPtr[] = {
		&body.nEnvType,	&body.nCookie,	&body.nSvrOrderID, 
		&body.nLocalOrderID, &body.nSetOrderStatus,		
	};
...
//tomodify 8
void CProtoSetOrderStatus::GetProtoBodyField_Ack(VT_PROTO_FIELD &vtField, const ProtoAckBodyType &ackData)
{
	static BOOL arOptional[] = {
		FALSE,	FALSE, TRUE, TRUE, FALSE,		
	};
	...
	void *arPtr[] = {
		&body.nEnvType,	&body.nCookie,	&body.nSvrOrderID,
			&body.nLocalOrderID, &body.nSvrResult,		
	};
