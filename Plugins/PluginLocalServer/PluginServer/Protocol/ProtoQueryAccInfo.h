...
class CProtoQueryAccInfo : public CProtoParseBase
{
public:
	//tomodify 1
	typedef QueryAccInfo_Req		ProtoReqDataType;
	typedef QueryAccInfo_Ack		ProtoAckDataType;

	//tomodify 2
	typedef QueryAccInfoReqBody	   ProtoReqBodyType;
	typedef QueryAccInfoAckBody	   ProtoAckBodyType;


public:
	CProtoQueryAccInfo();
	virtual ~CProtoQueryAccInfo();
