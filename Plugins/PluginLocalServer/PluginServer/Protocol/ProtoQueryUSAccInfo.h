...
class CProtoQueryUSAccInfo : public CProtoParseBase
{
public:
	//tomodify 1
	typedef QueryUSAccInfo_Req		ProtoReqDataType;
	typedef QueryUSAccInfo_Ack		ProtoAckDataType;

	//tomodify 2
	typedef QueryUSAccInfoReqBody	   ProtoReqBodyType;
	typedef QueryUSAccInfoAckBody	   ProtoAckBodyType;


public:
	CProtoQueryUSAccInfo();
	virtual ~CProtoQueryUSAccInfo();
