...
class CProtoOrderErrorPush : public CProtoParseBase
{
public:
	//tomodify 1
	typedef OrderErrorPushHK_Req		ProtoReqDataType;
	typedef OrderErrorPushHK_Ack		ProtoAckDataType;

	//tomodify 2
	typedef OrderErrorPushHKReqBody	   ProtoReqBodyType;
	typedef OrderErrorPushHKAckBody	   ProtoAckBodyType;


public:
	CProtoOrderErrorPush();
	virtual ~CProtoOrderErrorPush();
